<template>
  <div id="app" class="min-h-screen bg-grey-darker p-8">
    <div class="max-w-sm mx-auto card mt-8">
      <label for="" class="form-label mb-2">Renderless Stacked Layout</label>
      <stacked-tag-input v-model="tags"></stacked-tag-input>
    </div>

    <div class="max-w-sm mx-auto card mt-8">
      <label for="" class="form-label mb-2">Inline Tag Input</label>
      <inline-tag-input v-model="tags"></inline-tag-input>
    </div>
    <div class="max-w-sm mx-auto card mt-8">
      <label for="" class="form-label mb-2">Original Tag Input</label>
